 ...
 * @author Hùng
 */
@WebServlet(name = "preupdate", urlPatterns = {"/preupdate"})
public class PreUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Category> listgetAllCategory = daoC.getAllCategory();
        List<Product> listgetProductById = daoP.getProductById(pid);
